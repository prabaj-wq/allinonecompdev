            ...
            try:
                ...
                if data_type == 'entity_amounts':
                    ...
                    if data.get('from_entity_id'):
                        cur.execute("SELECT entity_code, entity_name FROM axes_entities WHERE id = %s OR entity_code = %s::text", 
                    ...
                    if data.get('from_account_id'):
                        cur.execute("SELECT account_code, account_name FROM axes_accounts WHERE id = %s OR account_code = %s::text", 
